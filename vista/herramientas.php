...
<div class="wrapper jsc-sidebar-content jsc-sidebar-pulled">
	...
	<section class="main-content">
      ...
      <br><br><br><br><br><br><br>
              ...
              <form method="post" action="../modelo/cambioContrasena.php">
                   <div><label>Usuario : <?php echo $nombre." ".$apellido1." ".$apellido2 ?> </label></div>
                   <div><input type="password" name="passwordActual" placeholder="Contraseña actual"  required></div>
                   <div><input type="password" name="passwordNuevoA" placeholder="Contraseña Nueva"  required></div>
                   <div></label><input type="password" name="passwordNuevoB" placeholder="Contraseña Nueva"  required></div>
